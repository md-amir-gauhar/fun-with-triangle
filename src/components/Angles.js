...
const Angles = () => {
  ...
  const handleClick = () => {
    if (a === "" || b === "" || c === "") {
      ...
      setResult('Yes, this set of angles can form a triangle. Any set of three angles that add upto 180 degrees can form a triangle except for zeros');
    }
    ...
    <div className="app">
      <div className="container">
        ...
        <div className="input_container">
          ...
          <input type="number" className="inputs" value={c} onChange={e => setC(e.target.value)} />
        </div>
